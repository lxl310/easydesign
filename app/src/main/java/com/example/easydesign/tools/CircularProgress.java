...
import com.example.easydesign.R.color;
import com.example.easydesign.R.styleable;
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, styleable.CircularProgress, defStyleAttr, 0);
        mBorderWidth = a.getDimension(styleable.CircularProgress_borderWidth,
                DEFAULT_BORDER_WIDTH * density);
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(color.myred);
        mColors[1] = context.getResources().getColor(color.myyellow);
        mColors[2] = context.getResources().getColor(color.mygreen);
        mColors[3] = context.getResources().getColor(color.myblue);
